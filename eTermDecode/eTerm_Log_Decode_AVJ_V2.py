...
writer.writerow([u'Flt_No',u'Flt_Date',u'Seg',u'STD',u'STA',u'Aircraft','P','F','A','O','J','C','D','Z','R','G','E','Y','B','M','U','H','Q','V','W','S','T','L','X','N','K'])

def cls_decode(cls_text):
	cls_inf=[]
	tmp_status=[]
	for char in 'PFAOJCDZRGEYBMUHQVWSTLXNK':
