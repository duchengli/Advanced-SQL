            ...
            for result in results:
                try:
                    ...
                    if post_reply > 0 and post_like > 0:  # 判断是否是热帖
                        ...
                        post_lists.append((post_title,post_date,post_link, post_view, post_reply, post_like))
                except:
                    pass
...
#对post_lists进行降序排序然后再打印
for i in sorted(post_lists, key=lambda  x:x[3], reverse=True):
    print(i)
